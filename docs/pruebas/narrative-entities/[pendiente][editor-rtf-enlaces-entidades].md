# Pruebas - Editor RTF con enlaces a entidades narrativas

- [x] Matching enlaza nombres capitalizados de personaje.
- [x] Matching enlaza apodos y navega al personaje propietario.
- [x] Matching enlaza localizaciones multi-palabra.
- [x] Matching no enlaza palabras comunes en minuscula.
- [x] Matching respeta tildes.
