...
- [ ] **1. Alinear el contrato de avisos de peticiones, reportes y alegaciones.**
  ...
  - [ ] Clasificar la respuesta backend y actualizar tipos, clientes y documentación de integración.
  - [ ] Mantener `notification.created` y REST como señales compatibles y deduplicadas por destinatario y evento.

- [ ] **2. Exponer Normas de comunidad como sección administrativa propia.**
  ...
  - [ ] Crear la sección `Normas de comunidad` en Administración, exclusiva para administradores.
  - [ ] Reutilizar los endpoints actuales de borrador y publicación para Uso y Creación, mostrando si existe versión activa.
  - [ ] Extraer el editor de la gestión de cuentas y conservar confirmación, validación y mensajes funcionales.

- [ ] **3. Navegar avisos al lugar de trabajo correcto.**
  ...
  - [ ] Añadir estado de sección al deep link de Administración y validarlo contra los guards efectivos.
  - [ ] Resolver destinos exclusivamente con códigos y contextos discriminados del contrato.
  - [ ] Mostrar destino no disponible sin perder el aviso cuando falle la autorización o el recurso ya no exista.

- [ ] **4. Distinguir normas no publicadas de errores de carga.**
  ...
  - [ ] Distinguir `active_policy_not_found` de los fallos recuperables en Perfil.
  - [ ] Mantener consulta y lectura de normas vigentes también para administradores, sin mostrarles el banner automático.
