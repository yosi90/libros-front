...
- La migración Firebase está implementada y su campaña alojada Chromium/Firefox `32734302486` está verde; solo permanecen pendientes el smoke Google OAuth manual y la autorización explícita del propietario antes del visto bueno al corte productivo.
...
- Hito 13 implementado hasta 13.4 y aceptación automatizada 13.5 verde contra la release QA corregida; espera únicamente el smoke Google OAuth manual acotado y la decisión explícita del propietario.
