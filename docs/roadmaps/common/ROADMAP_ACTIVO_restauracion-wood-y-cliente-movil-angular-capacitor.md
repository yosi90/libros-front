...
- [ ] **Hito 5 - Ejecutar el spike técnico Android.**
  - **Estado:** en progreso. Capacitor 8, flavors Android, Firebase QA y los adaptadores nativos están incorporados. En un Honor Magic V3 han pasado contraseña, Google, teléfono, sesión opaca, Firebase canónico/realtime, revocación y entrega FCM real. Solo falta desplegar la asociación QA y acreditar la verificación automática de App Links. Evidencia y puerta en `ANDROID_SPIKE_HITO_5.md`.
