...
- [ ] **Hito 12 - Consolidar web móvil, PWA y plegables.**
  - **Estado:** en curso. Mobile está activado en la configuración QA y continúa apagado en producción. Light/dark, su selector, sus servicios y 3.507 líneas de Sass condicional han sido retirados; el contrato histórico `wood|light|dark` permanece tolerado en los tipos de API, pero ya no gobierna la presentación ni origina sincronización desde el frontend. La matriz local pasa en Chromium y Firefox entre 320 y 3440 px, cubre explícitamente 360/390/600/800/1050/1051, portrait/landscape, plegable compact/medium y conservación de formularios al sustituir Mobile/Wood. Los 284 tests unitarios, builds producción/QA, 33 contratos QA, verificación del artefacto PWA y 39 pruebas responsive/públicas están verdes. La campaña `33253376867` desplegó el SHA en Hosting QA y superó artefacto, App Links y 42/45 smokes aplicables; falló únicamente porque un test medium esperaba el nombre Wood «Continuar con Google» frente al nombre Mobile «Google». El caso corregido pasa alojado en Chromium, Firefox y WebKit. El Honor Magic V3 actualizó explícitamente un shell anterior y verificó Mobile medium a 718x652 CSS px sin overflow, doble árbol ni colisión entre Angular Service Worker y Messaging. Se añade comprobación de actualizaciones al arranque para que futuras versiones ofrezcan inmediatamente la acción, sin recarga automática. Falta relanzar la campaña completa y completar el smoke físico plegado antes de cerrar el hito o activar producción.
