...
- [ ] **Hito 8 - Adaptar biblioteca y cuenta a Mobile.**
  ...
  - **Avance operativo:** compact usa navegación inferior funcional y medium el mismo componente como rail; ambos ofrecen Biblioteca, Catálogo, Comunidad y Más. Más agrupa perfil, seguridad, estadísticas, gestores, mensajería y logout sin exponer administración. La biblioteca Mobile reutiliza carga, filtros, búsqueda, agrupación, apertura, estado/puntuación y store de scroll de `BooksComponent`; solo cambia su vista. Build de producción y 289 unitarias pasan. Quedan catálogo/ficha, cuenta, preferencias y la validación Playwright autenticada antes de cerrar el hito.
