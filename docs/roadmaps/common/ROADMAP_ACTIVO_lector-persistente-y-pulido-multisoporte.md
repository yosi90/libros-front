...
- [ ] **Shell, navegación y biblioteca/catálogo**
  ...
  - [ ] **Editor de estado y avisos accionables:** presentar el editor de los tres puntos y los avisos con enlace como superficies fullscreen con flecha en Android y web compact, manteniendo modal centrado en Mobile medium y el modal editorial existente en Wood. Ambos formatos Mobile deben consumir los tokens light/dark, atrapar el foco, respetar safe areas y dar prioridad al back físico sin permitir que un aviso no descartable se salte.
