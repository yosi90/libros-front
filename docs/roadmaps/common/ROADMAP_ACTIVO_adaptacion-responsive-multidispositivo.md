...
- [ ] **Hito 13 - Migrar la autenticación completa a Firebase y sincronizar preferencias.**
  ...
  - **Avance operativo:** backend corrigió el vínculo telefónico en la release `16090b4ce05eda9307da29679bdfc9cb6e1616ee` y el dataset `2026.08.4`; la validación focal `32733090045` confirmó teléfono `2/2`. Tras corregir la carrera estrictamente transitoria del keepalive, la campaña completa `32734302486` sobre el commit frontend `5ea48be285b267f057f1a13759fb28fcd0ad0f74` quedó verde: gate determinista, build QA, integración local Chromium/Firefox, despliegue Hosting, 12 smokes públicos y 12 recorridos alojados de password/refresh/teléfono. El cleanup restauró `baseline`, liberó la lease y publicó el artefacto sanitizado `9522877825`. El borrador de visto bueno queda preparado con esas releases y evidencias. Solo faltan el smoke Google OAuth manual y la confirmación explícita del propietario; el Hito 13 y producción permanecen sin aprobación hasta entonces.
