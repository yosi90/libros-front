...
- [ ] **Hito 13 - Migrar la autenticación completa a Firebase y sincronizar preferencias.**
  ...
  - **Avance operativo:** backend corrigió el vínculo telefónico en la release `16090b4ce05eda9307da29679bdfc9cb6e1616ee`; la campaña automática completa `32746025039` quedó verde y el smoke Google QA real completó OAuth. Producción publica correctamente Firebase y la release limpia `a7c1a8593015278575ae86b2c99a3fad09d1fa90` implementa la confirmación para vincular una identidad Google cuyo correo difiere del principal. Antes de adaptar el front falta tipar en OpenAPI las dos direcciones enmascaradas de `details`; se solicita en `docs/peticiones/completar-contrato-confirmacion-google-correo-distinto.md`. Backend debe conservar `usuarios.password` y el rollback hasta repetir login password, confirmación, login Google, datos/preferencias y restauración.
