...
- [ ] **Hito 13 - Migrar la autenticación completa a Firebase y sincronizar preferencias.**
  ...
  - **Checks 13.3 - Cuenta y seguridad:**
    ...
    - [x] Confirmar explícitamente la vinculación Google cuando su correo verificado difiere del principal, mostrando solo los valores enmascarados por backend y conservando la prueba Firebase únicamente en memoria durante el diálogo.
  ...
  - **Avance operativo:** backend corrigió el vínculo telefónico en la release `16090b4ce05eda9307da29679bdfc9cb6e1616ee`; la campaña automática completa `32746025039` quedó verde y el smoke Google QA real completó OAuth. Producción publica Firebase en la release limpia `315ae4b06aa7aadab96dccba2972bb6306207157`, que tipa y permite la confirmación para vincular una identidad Google cuyo correo difiere del principal. El frontend desplegó el diálogo efímero, el reintento con el mismo token y contratos separados para Google/teléfono; el propietario completó correctamente el smoke productivo y confirmó que Google entra en la misma cuenta conservando sus datos. Como último defecto de descubribilidad, `/dashboard/account-security` quedó añadido como destino explícito en sidebar y panel “Más”; falta comprobar ese acceso tras su despliegue antes del visto bueno final para retirar `usuarios.password`.
