...
- [ ] **Hito 13 - Migrar la autenticación completa a Firebase y sincronizar preferencias.**
  ...
  - **Avance operativo:** backend corrigió el vínculo telefónico en la release `16090b4ce05eda9307da29679bdfc9cb6e1616ee`; la campaña automática completa `32746025039` quedó verde y el smoke Google QA real completó OAuth. Producción publica correctamente Firebase sobre `d6e86e0cf099bb95b50ec9c04cebabd47f63ceab`, pero el smoke final reveló que una cuenta Outlook existente no puede vincular una identidad Google con correo distinto por la regla contractual de igualdad. `docs/peticiones/permitir-vincular-google-con-correo-principal-distinto.md` solicita una confirmación explícita segura sin fusionar cuentas por email. Backend debe conservar `usuarios.password` y el rollback hasta repetir login password, vínculo, login Google, datos/preferencias y restauración.
