...
- [ ] **Hito 13 - Migrar la autenticación completa a Firebase y sincronizar preferencias.**
  ...
  - **Avance operativo:** backend corrigió el vínculo telefónico en la release `16090b4ce05eda9307da29679bdfc9cb6e1616ee`; la campaña automática completa `32746025039` quedó verde y el smoke Google QA real completó OAuth. Producción publica Firebase en la release limpia `315ae4b06aa7aadab96dccba2972bb6306207157`, que tipa y permite la confirmación para vincular una identidad Google cuyo correo difiere del principal. El frontend ya implementa el diálogo efímero, el reintento explícito con el mismo token y contratos separados para Google/teléfono; unitarias, OpenAPI, tipos E2E y builds producción/QA están verdes. Falta desplegar esta entrega y repetir el smoke productivo de login password, confirmación, login Google, datos/preferencias, restauración y logout final. Backend debe conservar `usuarios.password` y el rollback hasta recibir ese visto bueno.
