...
- [ ] **Gestión del catálogo en Administración** *(replanteado el 25/9 tras la revisión del propietario)*
  ...
  - **Antologías bloqueado:** `GET /antologias/{id}` responde 500 en producción y no hay una lectura documentada de su universo y saga; petición `docs/peticiones/corregir-500-detalle-antologia.md`.
