...
- [x] **Notas del libro** (26/9, petición del propietario): nueva subruta `notes` con `BookNotesComponent` y vistas Web, Mobile/APK y Wood (buscar, crear, editar y borrar con confirmación en la propia tarjeta). Accesos: pestaña «Notas» en Web, botón en la barra Wood y en su panel compacto, y botón en la barra del libro Mobile. Consume `/notas/libro/{id}` y `/notas`; como `ENDPOINTS.md` marca la escritura como Admin, se pide aclararlo en `docs/peticiones/notas-de-libro-propias.md`.
