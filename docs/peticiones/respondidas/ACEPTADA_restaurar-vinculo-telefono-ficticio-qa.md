...
La validación focal frontend `32733090045`, ejecutada contra Hosting QA desde el commit `9f013ab9ec5884392534ceedd582bb2d0ffca759`, confirma la corrección: el recorrido telefónico aislado pasa en Chromium y Firefox (`2/2`) con el dataset `2026.08.4`. El cleanup restaura `baseline`, libera la lease y publica únicamente evidencia sanitizada. La petición queda funcionalmente cerrada; cualquier incidencia posterior distinta requerirá una petición nueva con alcance propio.
