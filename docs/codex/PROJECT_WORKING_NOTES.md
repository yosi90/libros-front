...
- Los Hitos 13 y 14 están finalizados. Producción publica Firebase sobre backend `315ae4b06aa7aadab96dccba2972bb6306207157` y el frontend quedó migrado secuencialmente a Angular 22.1.3 con Node 24.15.0 y `@angular/build` 22.1.5. Instalación limpia, contratos, build producción/QA, 252 unitarias y smoke Chromium/Firefox están verdes; `docs/roadmaps/common/ANGULAR_22_COMPATIBILITY.md` conserva la matriz y los puntos de retorno. El siguiente foco es la QA integral del Hito 15. El rediseño visual integral de light/dark se abordará después del roadmap y no debe mezclarse con esa campaña.
