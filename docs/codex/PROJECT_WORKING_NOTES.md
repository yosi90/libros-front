...
- El Hito 13 está finalizado. Producción publica Firebase sobre backend `315ae4b06aa7aadab96dccba2972bb6306207157`; frontend `4537a11` resolvió Google con correo distinto y `0b168e8` expuso Cuenta y seguridad. Ambos despliegues están verdes y el propietario confirmó el smoke completo, incluida navegación, misma cuenta, datos, preferencias y restauración. `docs/peticiones/confirmar-smoke-productivo-final-autenticacion-firebase.md` autoriza a backend a ejecutar el post-corte con sus guardas. El siguiente foco es la evaluación de compatibilidad del Hito 14; QA integral continúa en el Hito 15. El rediseño visual integral de light/dark se abordará después del roadmap y no debe mezclarse con el upgrade Angular.
