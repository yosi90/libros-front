...
- El Hito 13 tiene implementados 13.0–13.4: sesión Firebase/JWT en memoria, password/Google/teléfono, onboarding y retornos de correo, cuenta y seguridad, revocaciones y preferencias multidispositivo. Backend QA `e9c87f25e30f73ce240f08b54d3d14c02c3b32cf` y dataset `2026.08.3` son la base contractual. Los gates locales están verdes; 13.5 espera el workflow manual con secretos del Environment `qa`, cinco perfiles Chromium/Firefox, teléfono ficticio, restauración Strict en `qa-libros.yosiftware.es`, smoke Google manual y cleanup final `baseline`. No enviar visto bueno ni autorizar producción sin confirmación explícita del propietario. QA integral continúa en el Hito 15 como regresión final.
