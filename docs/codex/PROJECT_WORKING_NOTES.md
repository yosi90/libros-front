...
- Hitos 0-9 están cerrados y el Hito 10 es el siguiente foco. El shell autenticado y las áreas de biblioteca/cuenta ya tienen vistas Mobile independientes; el gestor unificado de autores, universos, sagas, antologías y libros aporta lista compacta, maestro-detalle medium y paridad de sus acciones sin duplicar servicios. Adaptar ahora el shell de libro, índice, búsqueda, estadísticas y editores narrativos táctiles, protegiendo autosave, selección RTF y borradores al cruzar `1050/1051`. La flag sigue apagada fuera de la previsualización local `localStorage['book-front:mobile-presentation-preview']='true'` y Capacitor. La revisión Playwright autenticada de las superficies Mobile se realizará al activar la flag en QA durante H12. El spike Android queda aprobado en `docs/roadmaps/common/ANDROID_SPIKE_HITO_5.md`; H13/H14 conservan firma, configuración productiva y distribución.
