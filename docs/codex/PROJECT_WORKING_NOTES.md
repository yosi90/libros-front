...
- Continuar por el Hito 9 de `docs/roadmaps/common/ROADMAP_ACTIVO_adaptacion-responsive-multidispositivo.md`: adaptar personajes, organizaciones, eventos, localizaciones, conceptos y citas, incluidas relaciones, aliases, entradas y modales. El Hito 8 dejó capítulos y escenas operables desde 320 px, con scroll único, inset de teclado, escena adaptada por container query, asignación táctil sin depender de drag, toolbar RTF moderna, estado de autosave y contención de `1900px` en ultrawide. Los contratos existentes de escena aceptable, validación posterior, guardado de salida, páginas, textos por defecto, keywords y selección RTF deben preservarse. `src/assets/css/_modern-workspace.sass` sigue siendo la base de superficies, controles, focus y contenedores narrativos. Wood no debe usarse como plantilla responsive ni recibir el rediseño moderno salvo correcciones funcionales o transversales. La portada y autenticación consumirán el selector de tema en el Hito 11; Material Icons deberá hacerse autosuficiente para offline en el Hito 12. QA integral quedó finalizado por consolidación en `docs/roadmaps/qa/ROADMAP_FINALIZADO_qa-integral-front.md`; sus pendientes están absorbidos por el último hito activo y las campañas contractuales aceptadas no deben repetirse.
