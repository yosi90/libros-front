...
- Hitos 0-11 están cerrados. El siguiente foco es H12: activar Mobile en QA, validar web/PWA en 360/390/600/800/1050/1051, orientación y plegables, retirar light/dark y consolidar el service worker. Comunidad, perfiles, clubes, mensajería y notificaciones ya tienen árboles Mobile propios sobre los mismos controladores, stores y listeners realtime. En conversación, `MobileChatConversationViewComponent` transfiere su `#messageList` al controlador porque `ViewChild` no atraviesa componentes; preservar ese puente al tocar scroll, carga anterior o mensajes correlacionados. La flag sigue apagada fuera de la previsualización local `localStorage['book-front:mobile-presentation-preview']='true'` y Capacitor hasta iniciar H12. El spike Android queda aprobado en `docs/roadmaps/common/ANDROID_SPIKE_HITO_5.md`; H13/H14 conservan firma, configuración productiva y distribución.
