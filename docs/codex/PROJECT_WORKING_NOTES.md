...
- El Hito 13 tiene implementados 13.0–13.4 y la aceptación automatizada de 13.5 está verde. La campaña completa `32734302486`, commit frontend `5ea48be285b267f057f1a13759fb28fcd0ad0f74`, contra backend `16090b4ce05eda9307da29679bdfc9cb6e1616ee` y dataset `2026.08.4`, superó gate determinista, build QA, integración local Chromium/Firefox, despliegue Hosting, smoke público, restauración password/refresh Strict y teléfono alojado en ambos navegadores. El cleanup restauró `baseline`, liberó la lease y publicó evidencia sanitizada en el artefacto `9522877825`. Solo quedan el smoke OAuth real manual con la cuenta Google QA dedicada y la confirmación explícita del propietario antes de enviar el visto bueno o autorizar producción. QA integral continúa en el Hito 15 como regresión final.
