...
- Continuar por el Hito 5 de `docs/roadmaps/common/ROADMAP_ACTIVO_adaptacion-responsive-multidispositivo.md`: adaptar biblioteca y catálogo sobre el shell moderno. El Hito 4 separó la composición editorial wood, exclusiva de escritorio, del shell light/dark adaptativo: app bar/bottom navigation compactas, rail medium y sidebar moderna etiquetada en desktop, todos con un único contenido enrutado y estado compartido. También dejó panel Más, base del shell de libro con índice overlay, chat flotante solo desktop y guard de administración por capacidad de layout. Wood no debe usarse como plantilla responsive ni recibir el rediseño moderno salvo correcciones funcionales o transversales. El icono arrastrable y el bottom sheet heredados se retiraron. La portada y autenticación consumirán el selector de tema en el Hito 11; Material Icons deberá hacerse autosuficiente para offline en el Hito 12. QA integral quedó finalizado por consolidación en `docs/roadmaps/qa/ROADMAP_FINALIZADO_qa-integral-front.md`; sus pendientes están absorbidos por el último hito activo y las campañas contractuales aceptadas no deben repetirse.
