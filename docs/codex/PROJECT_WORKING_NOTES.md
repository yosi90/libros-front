...
- Hitos 0-15 están técnicamente cerrados. Mobile está activado en QA y producción para compact/medium; escritorio y ultrawide conservan Wood desde 1051 CSS px, y Capacitor fuerza `native-mobile`. La campaña final `33330830652`, sobre `cb4d8e6`, terminó verde con gates, builds, unitarias, navegadores, PWA, App Links, sesiones/proveedores Firebase, superficies Wood/Mobile, WCAG, cleanup, baseline y escaneo de secretos. El Honor Magic V3 confirmó actualización hasta `1.0.9-qa` conservando datos, arranque rápido, teléfono, Google, onboarding, biblioteca y restauración de sesión tras cierre. El candidato productivo firmado `33330832030` está verde y sin publicar. `docs/roadmaps/common/QA_INTEGRAL_HITO_15.md` reúne la evidencia. La única acción restante para finalizar y archivar el roadmap es la primera GitHub Release productiva, que exige autorización explícita del propietario.
